...
$rpli = mysqli_query($koneksi, "SELECT * FROM pelanggaran WHERE nama_kelas = 'XII-RPL-I'");
$i = mysqli_num_rows($rpli);
$rplii = mysqli_query($koneksi, "SELECT * FROM pelanggaran WHERE nama_kelas = 'XII-RPL-II'");
$ii = mysqli_num_rows($rplii);
$rpliii = mysqli_query($koneksi, "SELECT * FROM pelanggaran WHERE nama_kelas = 'XII-RPL-III'");
$iii = mysqli_num_rows($rpliii);
$mm = mysqli_query($koneksi, "SELECT * FROM pelanggaran WHERE nama_kelas = 'XII-Multimedia'");
$m = mysqli_num_rows($mm);
                    ...
                    <div class="row">
                        ...
                        <div class="card border-left-success shadow h-100 py-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">XII RPL I</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><a href="dataxiirpl1.php"><?= $i; ?> Siswa</a></div>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="card border-left-success shadow h-100 py-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">XII RPL II</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><a href="dataxiirpl2.php"><?= $ii; ?> Siswa</a></div>
                                </div>
                                <div class="col-auto">
                                <i class="fas fa-users fa-4x text-gray-300"></i>
                                </div>
                        ...
                        <div class="card border-left-success shadow h-100 py-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">XII RPL III </div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><a href="dataxiirpl3.php"><?= $iii; ?> Siswa</a></div>
                                </div>
                                <div class="col-auto">
                                <i class="fas fa-users fa-4x text-gray-300"></i>
                                </div>
                        ...
                        <div class="card border-left-info shadow h-100 py-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">XII Multimedia</div>
                                <div class="row no-gutters align-items-center">
                                    <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><a href="dataxiimm.php"><?= $m;?> Siswa</a></div>
                                    </div>
                                </div>
                                </div>
                                <div class="col-auto">

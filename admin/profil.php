        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="card shadow mb-4 col-lg-6">
                    ...
                    <div class="card-body">
                        <?php
                        $kelas = mysqli_query($koneksi, "SELECT * FROM admin ORDER BY admin_id");
                        $k = mysqli_fetch_array($kelas);
                        ?>
                    <form action="proses_edit_profil.php" method="POST">
                    <input type="hidden" name="admin_id" value="<?= $k['admin_id']; ?>">
                        <div class="form-group">
                        <label for="exampleInputEmail1">Nama</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan Nama Admin" name="nama_adm" value="<?= $k['nama_adm']; ?>" required>
                        </div>
                        <div class="form-group">
                        <label for="exampleInputEmail1">Email</label>
                        <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan Email" name="email_adm" value="<?= $k['email_adm']; ?>" required>
                        </div>
                        <div class="form-group">
                        <label for="exampleInputEmail1">Password</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan Password" name="password" value="<?= $k['password']; ?>" required>
                        </div>

                ...
                <div class="card shadow mb-4 col-lg-6">
                    ...
                    <form action="tambah_proses.php" method="POST">
                        ...
                        <select name="nama_kelas" id="nama_kelas" class="form-control" required>
                            <option value="">== Masukan Nama Kelas ==</option>
                        ...
                        <input type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Total Siswa" name="jumlah_siswa" required>
                        </div>
                        <div class="form-group">
                        <label for="exampleInputEmail1">Wali Kelas</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Wali Kelas" name="nama_wali" required>
                        </div>
